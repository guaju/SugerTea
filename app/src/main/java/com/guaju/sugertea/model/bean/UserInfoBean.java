...
public class UserInfoBean {
    ...
    protected UserInfoBean(Parcel in) {
        ...
        this.zhiyeid = in.readString();
        this.birthday = in.readString();
        this.location = in.readString();
        this.cid = in.readString();
        this.idpics = in.readString();
        this.idpicss = in.readString();
        this.if_work = in.readString();
        this.qqopenid = in.readString();
        this.shequid = in.readString();
        this.renzhengtime = in.readString();
        this.shanghunicheng = in.readString();
        this.zhiyezhao = in.readString();
        this.shenheshijian = in.readString();
        this.tuijian = in.readString();
        this.jinyongshijian = in.readString();
        this.shanghujinyong = in.readString();
        this.money = in.readString();
        this.xinxianshishu = in.readString();
        this.xuanshangshu = in.readString();
        this.wendashu = in.readString();
        this.huodongshu = in.readString();
        this.farenwushu = in.readString();
        this.jierenwushu = in.readString();
        this.xiadanshu = in.readString();
        this.jiedanshu = in.readString();
        this.renwupinglunshu = in.readString();
        this.renwupingfen = in.readString();
